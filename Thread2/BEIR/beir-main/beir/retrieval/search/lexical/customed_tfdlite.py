...
class TFDLITE:
    ...
    def create_index(self):
        """Assume the index is created via curl command with DLITE similarity."""
        print(f"Index {self.config['index_name']} is assumed to be created via curl with DLITE similarity.")
