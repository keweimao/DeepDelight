...
def newsqa_loop(data, llm, output_csv_path, output_log_path, max_stories,
    ...
    with open(output_csv_path, 'w', newline='') as file:
        ...
        writer.writerow(['Dist_Func', 'Top_N', 'Time', 'Story Number', 'Question Number', 'EM', 'Precision', 'Recall', 'F1'])
            ...
            for top_n_sentence in top_n_sentences:
                ...
                for i, story in enumerate(data['data']):
                    ...
                    for j, question_data in enumerate(story['questions']):
                        ...
                        writer.writerow([dist_function, top_n_sentence, time.time() - start_time, i, j, em_score, precision, recall, f1_score_value])
...
output_csv_path = '../results/combined_score_sentence_0201.csv'
...
output_log_path = '../results/combined_score_sentence_0201.log'
