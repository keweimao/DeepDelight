...
output_file="training_times_test2_p.txt"
...
# For train_a2r2.py
start_time=$(date +%s)
python train_a2r2_p.py config/train_shakespeare_char_a2.py
end_time=$(date +%s)
cost_time=$(( end_time - start_time ))
min=$(( cost_time / 60 ))
sec=$(( cost_time % 60 ))
...
# For train_a2r5.py
start_time=$(date +%s)
python train_a2r5_p.py config/train_shakespeare_char_a2.py
end_time=$(date +%s)
cost_time=$(( end_time - start_time ))
min=$(( cost_time / 60 ))
sec=$(( cost_time % 60 ))
