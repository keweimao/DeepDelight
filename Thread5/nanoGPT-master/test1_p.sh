...
# Train the model
python train_a0r0_p.py config/train_shakespeare_char_a0.py
...
# For train_a2r0.py
start_time=$(date +%s)
python train_a2r0_p.py config/train_shakespeare_char_a2.py
end_time=$(date +%s)
cost_time=$(( end_time - start_time ))
min=$(( cost_time / 60 ))
sec=$(( cost_time % 60 ))
...
# For train_a5r0.py
start_time=$(date +%s)
python train_a5r0_p.py config/train_shakespeare_char_a5.py
end_time=$(date +%s)
cost_time=$(( end_time - start_time ))
min=$(( cost_time / 60 ))
sec=$(( cost_time % 60 ))
