...
plt.plot(val_losses_a2r0_4, label='Validation Loss a2r0_4')

plt.plot(val_losses_a2r2_4, label='Validation Loss a2r2_4')

plt.plot(val_losses_a2r5_4, label='Validation Loss a2r5_4')
